...
import { ArrowDown, ArrowUp, Download, FileText, FileArchive, Loader2, ShieldCheck, Trash2, Upload } from "lucide-react";
import { compressPdf } from "@/lib/pdf/operations/advanced";
import { InfoBlock, TextField, requireActiveDocument } from "./shared";
      ...
      <header className={styles.header}>
        <div className={styles.brandGroup}>
          ...
          <div>
            ...
            <h1>Compress PDF</h1>
            <p className={styles.headerDescription}>Optimasi ringan ukuran file di browser.</p>
          </div>
        </div>
      ...
      <section className={styles.toolWorkbench} aria-label="PDF tools workspace">
        ...
        <aside className={styles.actionPanel} aria-label="Tool options">
          ...
          <div className={styles.optionStack}>
            ...
            <InfoBlock title="Basic compression" text="Resave PDF dengan object streams. Hasil bisa lebih kecil atau sama, tergantung struktur file." />
          </div>
          ...
          <div className={styles.actionButtons}>
            <button className={styles.primaryButton} type="button" onClick={() => void tool.handleProcess(() => compressPdf(requireActiveDocument(tool.activeDocument).bytes))} disabled={!(canProcess)}>
