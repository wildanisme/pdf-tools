      ...
      <header className={styles.header}>
        <div className={styles.brandGroup}>
          ...
          <div>
            ...
            <h1>Extract PDF</h1>
            <p className={styles.headerDescription}>Ambil halaman tertentu dari satu PDF.</p>
          </div>
        </div>
      ...
      <section className={styles.toolWorkbench} aria-label="PDF tools workspace">
        ...
        <aside className={styles.actionPanel} aria-label="Tool options">
          ...
          <div className={styles.actionButtons}>
            <button className={styles.primaryButton} type="button" onClick={() => void tool.handleProcess(() => { const document = requireActiveDocument(tool.activeDocument); return extractPdfPages(document.bytes, parsePages(pageRange, document.pageCount)); })} disabled={!(canProcess)}>
