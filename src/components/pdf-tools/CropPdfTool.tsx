...
import { cropPdfPages } from "@/lib/pdf/operations/advanced";
      ...
      <header className={styles.header}>
        <div className={styles.brandGroup}>
          ...
          <div>
            ...
            <h1>Crop PDF</h1>
            <p className={styles.headerDescription}>Pangkas margin halaman PDF.</p>
          </div>
        </div>
      ...
      <section className={styles.toolWorkbench} aria-label="PDF tools workspace">
        ...
        <aside className={styles.actionPanel} aria-label="Tool options">
          ...
          <div className={styles.optionStack}>
            ...
            <NumberField label="Crop margin" value={cropMargin} onChange={setCropMargin} min={0} max={144} />
          </div>
          ...
          <div className={styles.actionButtons}>
            <button className={styles.primaryButton} type="button" onClick={() => void tool.handleProcess(() => cropPdfPages(requireActiveDocument(tool.activeDocument).bytes, cropMargin))} disabled={!(canProcess)}>
